...
export default function LocalSignUp() {
  ...
  const { signUp, signIn } = useLocalAuthContext();
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md glass-card p-7 sm:p-8 shadow-[0_20px_80px_rgba(0,0,0,0.55)]">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-sm text-muted-foreground mt-1">Start your private cognitive journaling journey</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button type="submit" className="w-full h-10 rounded-xl hero-btn text-white text-sm font-semibold">
            Continue
          </button>
        </form>
